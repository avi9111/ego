...
(function() {
  ...
  App = React.createClass({displayName: "App",
    ...
    ban: function() {
      var api;
      api = new Api();
      return api.Typ("banAccount").ServerID(this.state.select_server.serverName).AccountID(this.state.player_to_send).Key(this.props.curr_key).Params(31536000).Do((function(_this) {
    ...
    ban1: function() {
      var api;
      api = new Api();
      return api.Typ("banAccount").ServerID(this.state.select_server.serverName).AccountID(this.state.player_to_send).Key(this.props.curr_key).Params(1).Do((function(_this) {
        return function(result) {
          console.log("onSend");
          console.log(result);
          return _this.props.onSend();
    ...
    render: function() {
      return React.createElement("div", null, React.createElement(AccountKeyInput, Object.assign({}, this.props, {
        ...
        "onClick": this.ban
      }, "封禁账号1年"), React.createElement(antd.Button, {
        "className": 'ant-btn anticon-search ant-btn-primary ' + this.getLoadingState(),
        "onClick": this.ban1
      }, "解禁账号"));
    }
