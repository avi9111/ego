...
(function() {
  var AtcAdmin, AtcClientContorl, AtcClientList, AtcClientModify, AtcClientModifyModal, AtcClientNewModal, AtcProfileSelector, AtcRestClient, AtcSettings, AtcTitle, IPInput, nullfunc;
  ...
  AtcClientModifyModal = React.createClass({displayName: "AtcClientModifyModal",
    getInitialState: function() {
      return {
        data: this.props.data
      };
    ...
    montify: function() {
      var profile_data;
      profile_data = this.refs.selector1.GetSelectedProfile();
    ...
    render: function() {
      ...
      }, React.createElement("h4", null, "Modify ", this.state.data.ip), React.createElement("hr", null), React.createElement(AtcProfileSelector, {
        "ref": "selector1"
      })), React.createElement("div", {
  ...
  AtcClientModify = React.createClass({displayName: "AtcClientModify",
    getInitialState: function() {
      var set;
      set = new AtcSettings();
      return {
    ...
    changeSetting: function(setting) {
      ...
      console.log("ssss");
      console.log(setting);
      set = this.state.client.mkSetting(setting);
      console.log("ssss2");
      console.log(set);
      this.setState({
        settings: set
    ...
    render: function() {
      ...
      is_turn_on = this.state.is_turn_on;
      return React.createElement(ButtonToolbar, null, React.createElement(ModalTrigger, {
        "modal": React.createElement(AtcClientModifyModal, {
          "data": this.props.data,
  ...
  AtcClientList = React.createClass({displayName: "AtcClientList",
    ...
    AddOneToTable: function(data) {
      return React.createElement("tr", {
        "key": data.ip
      }, React.createElement("td", null, data.name), React.createElement("td", null, data.ip), React.createElement("td", null, React.createElement(AtcClientModify, {
        "data": data
      })));
    },
    ...
    render: function() {
      return React.createElement(Table, {
        ...
        "condensed": true,
        "hover": true
      }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Name"), React.createElement("th", null, "IP"), React.createElement("th", null, "Op"))), this.getTables());
    }
  });
  ...
  React.render(React.createElement(AtcAdmin, null), document.getElementById('all'));
