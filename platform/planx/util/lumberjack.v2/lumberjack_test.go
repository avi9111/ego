...
func TestOldLogFiles(t *testing.T) {
	...
	l := &Logger{FileTempletName: filename}
...
func TestTimeFromName(t *testing.T) {
	l := &Logger{FileTempletName: "/var/log/myfoo/foo.log"}
	prefix, ext := l.prefixAndExt()
	val, _ := l.timeFromName("foo-2014-05-04T14-44-33.555.log", prefix, ext)
	equals("2014-05-04T14-44-33.555", val, t)

	val, _ = l.timeFromName("foo-2014-05-04T14-44-33.555", prefix, ext)
	equals("", val, t)

	val, _ = l.timeFromName("2014-05-04T14-44-33.555.log", prefix, ext)
	equals("", val, t)

	val, _ = l.timeFromName("foo.log", prefix, ext)
	equals("", val, t)
}
	...
	data := []byte(`
{
	...
	isNil(err, t)
	equals("foo", l.FileTempletName, t)
